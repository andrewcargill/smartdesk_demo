...
function getCaptureLevelMark(level) {
            ...
            {learnObservationItems.map((item) => (
              ...
              <Typography sx={{ color: darkText, fontSize: 13.4, fontWeight: 850, lineHeight: 1.2 }}>
                ...
                {learnObservationChoices.map((choice) => {
                  ...
                  return (
                    <Box key={choice.id} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minWidth: 0 }}>
                      <Button
                        type="button"
                        variant="outlined"
                        ...
                        return (
                          <Button
                            ...
                            sx={{
                              ...
                              textTransform: 'none',
                            '&:hover': { bgcolor: isActive ? selectedPurple : '#fff', borderColor: isActive ? selectedPurple : darkText, color: isActive ? '#fff' : darkText },
                              '&:focus-visible': { outline: `2px solid ${purple}`, outlineOffset: 2 },
                            }}
                          >
                            {unit.label}
            ...
            >
              ...
              >
                ...
                {activeCapturePoints.map((capturePoint) => (
                  ...
                  >
                    <Typography sx={{ color: darkText, fontSize: 13.4, fontWeight: 850, lineHeight: 1.2, py: 0.45 }}>
                      {capturePoint.label}
                    </Typography>
                    {mathsCaptureLevels.map((level) => {
                      ...
                      return (
                        <Box key={level.id} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minWidth: 0 }}>
                          <Button
                            type="button"
                            variant="outlined"
