...
export const mathsCurriculumAreas = [
  {
    id: 'number-sense',
    title: 'Number sense and use of numbers',
    label: 'Number sense and use of numbers',
    labelEn: 'Number sense and use of numbers',
    labelSv: 'Taluppfattning och tals användning',
    officialTitleSv: 'Taluppfattning och tals användning',
    observationDimensions: [
      {
        id: 'numbers-properties',
        label: 'Numbers, properties and magnitude',
        labelEn: 'Numbers, properties and magnitude',
        labelSv: 'Tal, egenskaper och storleksordning',
      },
      {
        id: 'fractions-decimals-percentages',
        label: 'Fractions, decimals and percentages',
        labelEn: 'Fractions, decimals and percentages',
        labelSv: 'Bråk, decimaler och procent',
      },
      {
        id: 'powers-roots-standard-form',
        label: 'Powers, roots and standard form',
        labelEn: 'Powers, roots and standard form',
        labelSv: 'Potenser, rötter och grundpotensform',
      },
      {
        id: 'calculations-number-strategies',
        label: 'Calculations and number strategies',
        labelEn: 'Calculations and number strategies',
        labelSv: 'Beräkningar och talstrategier',
      },
      {
        id: 'estimation-reasonableness',
        label: 'Estimation and reasonableness',
        labelEn: 'Estimation and reasonableness',
        labelSv: 'Uppskattning och rimlighet',
      },
    ],
    type: 'content',
    order: 1,
    ...
    observationDimensions: [
      {
        ...
        labelEn: 'Algebraic expressions',
        labelSv: 'Algebraiska uttryck',
      },
      {
        id: 'simplification-rules',
        label: 'Simplification and algebraic rules',
        labelEn: 'Simplification and algebraic rules',
        labelSv: 'Förenkling och algebraiska regler',
      },
      {
        id: 'equations',
        label: 'Equations',
      ...
      {
        id: 'patterns-generalisation',
        label: 'Patterns and generalisation',
        labelEn: 'Patterns and generalisation',
        labelSv: 'Mönster och generalisering',
      },
      {
        id: 'algebraic-modelling',
        label: 'Algebraic modelling',
        labelEn: 'Algebraic modelling',
        labelSv: 'Algebraisk modellering',
      },
    ],
    type: 'content',
    order: 2,
    ...
    observationDimensions: [
      {
        ...
        label: 'Geometrical concepts and properties',
        labelEn: 'Geometrical concepts and properties',
        labelSv: 'Geometriska begrepp och egenskaper',
      },
      {
        id: 'length-area-volume',
        label: 'Length, area and volume',
        labelEn: 'Length, area and volume',
        labelSv: 'Längd, area och volym',
      },
      {
        id: 'scale-similarity',
        label: 'Scale and similarity',
        labelEn: 'Scale and similarity',
        labelSv: 'Skala och likformighet',
      },
      {
        id: 'geometrical-relationships',
        label: 'Geometrical relationships and theorems',
        labelEn: 'Geometrical relationships and theorems',
        labelSv: 'Geometriska samband och satser',
      },
      {
        id: 'construction-representation',
        label: 'Construction and geometrical representation',
        labelEn: 'Construction and geometrical representation',
        labelSv: 'Konstruktion och geometrisk representation',
      },
    ],
    type: 'content',
    order: 3,
  },
  {
    ...
    labelEn: 'Probability and statistics',
    labelSv: 'Sannolikhet och statistik',
    officialTitleSv: 'Sannolikhet och statistik',
    observationDimensions: [
      {
        id: 'tables-diagrams-data',
        label: 'Tables, diagrams and data',
        labelEn: 'Tables, diagrams and data',
        labelSv: 'Tabeller, diagram och data',
      },
      {
        id: 'measures-central-tendency',
        label: 'Measures of central tendency',
        labelEn: 'Measures of central tendency',
        labelSv: 'Lägesmått',
      },
      {
        id: 'variation-distribution',
        label: 'Variation and distribution',
        labelEn: 'Variation and distribution',
        labelSv: 'Spridning och fördelning',
      },
      {
        id: 'probability-calculations',
        label: 'Probability calculations',
        labelEn: 'Probability calculations',
        labelSv: 'Sannolikhetsberäkningar',
      },
      {
        id: 'interpretation-evaluation-data',
        label: 'Interpretation and evaluation of data',
        labelEn: 'Interpretation and evaluation of data',
        labelSv: 'Tolkning och värdering av data',
      },
    ],
    type: 'content',
    order: 4,
  },
  {
    ...
    labelEn: 'Relationships and change',
    labelSv: 'Samband och förändring',
    officialTitleSv: 'Samband och förändring',
    observationDimensions: [
      {
        id: 'relationships-between-quantities',
        label: 'Relationships between quantities',
        labelEn: 'Relationships between quantities',
        labelSv: 'Samband mellan storheter',
      },
      {
        id: 'proportionality',
        label: 'Proportionality',
        labelEn: 'Proportionality',
        labelSv: 'Proportionalitet',
      },
      {
        id: 'coordinates-graphs-formulas',
        label: 'Coordinates, graphs and formulas',
        labelEn: 'Coordinates, graphs and formulas',
        labelSv: 'Koordinater, grafer och formler',
      },
      {
        id: 'rate-of-change',
        label: 'Rate of change',
        labelEn: 'Rate of change',
        labelSv: 'Förändringstakt',
      },
      {
        id: 'functions-models',
        label: 'Functions and mathematical models',
        labelEn: 'Functions and mathematical models',
        labelSv: 'Funktioner och matematiska modeller',
      },
    ],
    type: 'content',
    order: 5,
  ...
  {
    id: 'mathematical-abilities',
    title: 'Mathematical abilities',
    label: 'Mathematical abilities',
    labelEn: 'Mathematical abilities',
    labelSv: 'Matematiska förmågor',
    officialTitleSv: 'Matematiska förmågor',
    observationDimensions: [
      {
        id: 'concepts',
        label: 'Concepts',
...
export const mathsAbilities = [
  { id: 'concepts', title: 'Concepts', label: 'Concepts', labelEn: 'Concepts', labelSv: 'Begrepp', officialTitleSv: 'Begrepp', type: 'ability', order: 1 },
  { id: 'methods', title: 'Methods', label: 'Methods', labelEn: 'Methods', labelSv: 'Metoder', officialTitleSv: 'Metoder', type: 'ability', order: 2 },
  { id: 'problem-solving', title: 'Problem-solving', label: 'Problem-solving', labelEn: 'Problem-solving', labelSv: 'Problemlösning', officialTitleSv: 'Problemlösning', type: 'ability', order: 3 },
  { id: 'reasoning', title: 'Reasoning', label: 'Reasoning', labelEn: 'Reasoning', labelSv: 'Resonemang', officialTitleSv: 'Resonemang', type: 'ability', order: 4 },
  { id: 'communication', title: 'Communication', label: 'Communication', labelEn: 'Communication', labelSv: 'Kommunikation', officialTitleSv: 'Kommunikation', type: 'ability', order: 5 },
];
...
export const mathsTeachingUnits = [
  {
    ...
    blockType: 'teaching',
    curriculumAreaIds: ['number-sense'],
